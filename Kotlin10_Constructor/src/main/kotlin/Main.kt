fun main(){
    ...
    println("t3.v1 : ${t3.v1}, t3.v2 : ${t3.v2}")

    val t4 = TestClass3(100, 100)
    println("t4.a1 : ${t4.a1}")
    println("t4.a2 : ${t4.a2}")
...
class TestClass1{
    ...
    // 매개 변수를 통해 정의할 수 없기 때문에 생성자는 아니다.
    init{
...
class TestClass2{
    ...
    // init 코드 블럭의 코드는 Java 파일로 변환될 때
    // 모든 생성자의 가장 위에 코드가 삽입된다.
    // 따라서 init 코드 블럭의 코드가 먼저 수행되고
    // 선택된 생성자가 수행된다.
    init{
        println("init 코드 블럭")
    }
...
// 만약 보조 생성자의 역할히 매개 변수로 들어오는 값을 멤버 변수에 담는 것만 한다면
// 주 생성자만 작성하는 방법이 있다.
//class TestClass3{
//
//    var a1 = 0
