fun main(){
    ...
    // data 클래스는 객체 생성시 생성자를 통해 정의된 멤버 변수의 값이 같은지를 비교한다.
    if(obj7 == obj8){
    ...
    // copy : 객체를 복제하여 새로운 객체를 만든다. (data class 에 있는 메서드)
    val obj9 = obj7.copy()
    ...
    // data class 를 통해서 만든 객체는 주 생성자에 정의한 멤버 변수를 componentN 메서드로 값을 받아올 수 있다.
