fun main(){
    ...
    // 만약 인터페이스를 구현하거나 클래스를 상속받은 클래스를 통해 객체를 하난만 생성한다면
    // 익명 중첩 클래스를 사용해도 좋다.
    ...
    val t3 = object : Inter1, Inter2{
        ...
        override fun interMethod3() {
            println("익명 중첩 클래스의 interMethod3")
        }

        override fun interMethod4() {
            println("익명 중첩 클래스의 interMethod4")
        }
...
// 일반 중첩 클래스
// 내부에 있는 클래스의 객체 생성은 외부 클래스로부터 생성한 객체를 통해 생성할 수 있다.
...
// 메서드를 오버라이딩한 클래스를 만들고 위로 올라가서 객체를 생성해서 사용해야 한다.
