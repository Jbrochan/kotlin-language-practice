          fun main(){
              ...
              // 반 공변성 : 변수에 설정한 제네릭이 객체를 생성할 때 사용한 제네릭의 자식 클래스인 경우에도 변수에 담을 수 있다.
          ...
          // < > : 안에 알파벳 문자를 넣어준다. 보통 대문자 한 글자를 작성한다.
          // 이 알파벳은 아직 결정되지 않은 타입을 의미한다.
          // 어떤한 타입인지 결정되지 않았지만 이 타입의 변수들을 정의하여 클래스를 작성하고
